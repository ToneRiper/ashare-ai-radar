...
def send_alert(text):
    ...
    if TOKEN and CHAT_ID:
        for part in parts:
            try:
                requests.post(f"https://api.telegram.org/bot{TOKEN}/sendMessage", json={"chat_id": CHAT_ID, "text": part, "parse_mode": "Markdown", "disable_web_page_preview": True}, timeout=15)
                time.sleep(0.5)
            except: pass

# ======================
# 5. 顶级合伙人 AI 大脑 (绝对无废话+价格死锁指令)
# ======================
